...
export class ItemsComponent implements OnInit {
    ...
    _wikitudeInstance: Wikitude;

    get wikitudeInstance() {
        return this._wikitudeInstance;
    }

    set wikitudeInstance( input: Wikitude ) {
        console.log(`attempting to assign ${input} to _wikitudeInstance`);

        if ( input ) {
            this._wikitudeInstance = input;
        }
    }
    ...
    switchCamera() {
        console.log('Attempting to change camera');
        if ( this.wikitudeInstance ) {
